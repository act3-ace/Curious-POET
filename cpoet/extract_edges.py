...
def parse_args():
    ...
    # parser.add_argument("--filename", type=str, required=False, default='stdout.log')
    parser.add_argument("--latest_log_filename", type=str, default='run.log') 
...
def get_iteration(line):
    ...
    iteration = int(line[line[:space_indices[0]].rfind('=')+1 : space_indices[0]])
